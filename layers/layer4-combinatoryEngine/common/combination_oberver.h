...
public:
    ...
    */
    ...
    /**
    * Update is the method executed after being notified by the combination policy
    * @param : combination. The combination policy notify that has produced a new combination.
    *          Its dependents must update the change automatically.
    */
    virtual void update(const std::set<T*>& combination) = 0;
