...
public:
    ...
    virtual ~L5ApplicationClient()
    {};

    /*
     * Extract the L4_Node from a given packet.
     * The client receives a packet from the server, it deserializes
     * this packet and creates a L4_Node from it.
